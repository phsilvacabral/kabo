<div class="moveboxfundo">
    <div class="boxfundo2">
        <div class="alignConteudo">
            ...
            <?php
            $id = $_GET['id'];
            $sql = "SELECT * FROM Produto_Tipo JOIN Armazenamento ON fk_Cod_Armazenamento = Armazenamento.Cod_Armazenamento WHERE Cod_Produto = $id";
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                ...
                <div class="alignTexts">
                    <p id="descricaoMarcaModelo">
                        <?php
                        echo 'Armazenamento' . ' ' . $row['Conexao'] . ' ' . $row['Marca'] . ' ' . $row['Modelo'] . ' ' . $row['Capacidade'] . ' ' . $row['Velocidade'] . 'Mb/s';
                        ?>
                    </p>
