<div class="moveboxfundo">
    <div class="boxfundo2">
        <div class="alignConteudo">
            ...
            <?php
            $id = $_GET['id'];
            $sql = "SELECT * FROM Produto_Tipo JOIN Teclado ON fk_Cod_Teclado = Teclado.Cod_Teclado WHERE Cod_Produto = $id";
            ...
            <?php while ($row = $result->fetch_assoc() and $rowEndereco = $resultEndereco->fetch_assoc() and $rowUsuario = $resultUsuario->fetch_assoc()) { ?>
                ...
                <div class="alignTexts">
                    <p id="descricaoMarcaModelo">
                        <?php
                        echo $row['Tipo'].' '.$row['Marca'] . ' ' . $row['Modelo'] . ' ' . $row['Cor'] . ' ' . $row['Iluminacao'];
                        ?>
                    </p>
                    ...
                    <div class="alignInRow">
                        <p>Formato</p>
                        <p><?php echo $row['Formato'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Switch</p>
                        <p><?php echo $row['Switch'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Cor</p>
