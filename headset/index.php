            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                ...
                <div class="alignTexts">
                    <p id="descricaoMarcaModelo">
                        <?php
                        echo 'Headset ' . $row['Marca'] . ' ' . $row['Modelo'] . ' ' . $row['Tipo_Conexao'] . ' ' . $row['Frequencia_Audio'].'Hz '.$row['Cor'];
                        ?>
                    </p>
                    ...
                    <div class="alignInRow">
                        <p>Driver</p>
                        <p><?php echo $row['Driver'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Frequencia do Audio</p>
                        <p><?php echo $row['Frequencia_Audio'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Conexão</p>
                    ...
                    <div class="alignInRow">
                        <p>Frequencia Microfone</p>
                        <p><?php echo $row['Frequencia_Mic'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Padrao Polar</p>
                        <p><?php echo $row['Padrao_Polar'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Iluminação</p>
