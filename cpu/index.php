<div class="moveboxfundo">
    <div class="boxfundo2">
        <div class="alignConteudo">
            ...
            <?php
            $id = $_GET['id'];
            $sql = "SELECT * FROM Produto_Tipo JOIN CPU ON fk_Cod_CPU = CPU.Cod_CPU WHERE Cod_Produto = $id";
            ...
            <?php while ($row = $result->fetch_assoc()) { ?>
                ...
                <div class="alignTexts">
                    ...
                    <div class="alignInRow">
                        <p>Threads</p>
                        <p><?php echo $row['Threads'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Frequência</p>
                        <p><?php echo $row['Frequencia'] ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>TDP</p>
