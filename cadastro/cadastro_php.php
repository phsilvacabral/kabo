    ...
    try {
        ...
        if ($checkResult && $checkResult->num_rows > 0) {
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                $sqlE = "INSERT INTO Endereco (CEP, Logradouro, Numero, Bairro, Cidade, Estado, fk_Cod_Usuario) VALUES ('$CEP', '$Logradouro', '$Numero', '$Bairro', '$Cidade', '$Estado', {$_SESSION['Cod_Usuario']})";
